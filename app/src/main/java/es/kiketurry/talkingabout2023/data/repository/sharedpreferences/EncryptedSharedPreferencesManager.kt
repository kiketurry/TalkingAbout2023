package es.kiketurry.talkingabout2023.data.repository.sharedpreferences

import android.content.SharedPreferences
import android.util.Log
import androidx.security.crypto.EncryptedSharedPreferences
import androidx.security.crypto.MasterKeys
import es.kiketurry.talkingabout2023.ui.base.TalkingAboutApplication


class EncryptedSharedPreferencesManager() {

    companion object {
        var INSTANCE: EncryptedSharedPreferencesManager? = null
    ...
    private val encryptedPreferencesFileName = "sharedPreferencesTalkingAbout2023"
    ...
    private fun initializeEncryptedSharedPreferencesManager(): SharedPreferences {
        return EncryptedSharedPreferences.create(
            ...
            masterKeyAlias,
            TalkingAboutApplication.getAppContext()!!,
