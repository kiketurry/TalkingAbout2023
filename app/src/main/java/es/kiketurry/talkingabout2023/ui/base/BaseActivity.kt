...
import es.kiketurry.talkingabout2023.R
...
import es.kiketurry.talkingabout2023.extension.gone
import es.kiketurry.talkingabout2023.extension.visible
import es.kiketurry.talkingabout2023.injection.InjectionSingleton
import es.kiketurry.talkingabout2023.ui.dialogfragment.loading.LoadingDialogFragment
import es.kiketurry.talkingabout2023.ui.dialogfragment.loading.LoadingDialogFragment.Companion.LOADING_DIALOG_FRAGMENT_TAG
import es.kiketurry.talkingabout2023.ui.dialogfragment.warning.WarningDialogFragment
import es.kiketurry.talkingabout2023.ui.dialogfragment.warning.WarningDialogFragment.Companion.ERROR_DIALOG_FRAGMENT_TAG
...
abstract class BaseActivity<B : ViewBinding> : AppCompatActivity(), View.OnClickListener {
    ...
    private val talkingAboutApplication: TalkingAboutApplication = TalkingAboutApplication()
    ...
    private val baseActivityControlShowLoading: BaseActivityControlShowLoading = InjectionSingleton.provideBaseActivityControlShowLoading()
    ...
    fun showErrorInformativeOnly(errorModel: ErrorModel) {
    ...
    fun showErrorInformativeOnly(errorModel: ErrorModel, warningDialogFragmentListener: WarningDialogFragment.WarningDialogFragmentListener) {
